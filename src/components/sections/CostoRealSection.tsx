...
/**
 * Costo Real Section
 * Updated to match the Figma design with stacked cards, no indicators, and png arrows.
 */
export default function CostoRealSection() {
    ...
    return (
        <section
            id="costo-real"
            ref={sectionRef}
            className="relative  flex items-center bg-[#48A57A] py-16 md:py-24 overflow-hidden"
        >
