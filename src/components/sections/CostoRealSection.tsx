                ...
                <div className="container-custom relative z-10 w-full">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-24 items-center">
                        ...
                        <div className="relative flex flex-col justify-start lg:pr-12">
                            ...
                            >
                                <h2 className="font-impact text-[1.75rem] xs:text-[2rem] sm:text-[2.5rem] lg:text-[4rem] xl:text-[4.2rem] 2xl:text-[4.5rem] text-black leading-[1] uppercase max-w-[18rem] sm:max-w-2xl">
                            ...
                            <motion.div
                                className="hidden sm:block absolute lg:relative top-[6.5rem] sm:top-[12rem] lg:top-0 xl:mt-14 2xl:mt-12 left-[-2rem] lg:left-[-8rem] z-10 
                                w-[4rem] sm:w-[18rem] lg:w-[36rem] xl:w-[38rem] 2xl:w-[45rem] opacity-40 lg:opacity-90 pointer-events-none"
                        ...
                        <div className="relative z-20 w-full flex justify-center mt-4 lg:mt-0">
                            <motion.div
                                className="w-full max-w-[22rem] xs:max-w-[24rem] sm:max-w-[36rem] "
                            ...
                            >
                                ...
                                >
                                    {cardsData.map((card, index) => (
                                        <SwiperSlide key={index} className="min-h-[24rem] xs:min-h-[24rem] xl:min-h-[30rem] 2xl:min-h-[40rem] rounded-[2rem] lg:rounded-[2.5rem] bg-[#FFB84D] shadow-2xl overflow-hidden">
                                            <div className="p-6 xs:p-8 lg:p-12 flex flex-col h-full relative">
                                                ...
                                                <div className="flex justify-center mb-4 lg:mb-8">
                                                    <motion.img
                                                        src={card.image}
                                                        alt=""
                                                        className="w-auto h-[5rem] xs:h-[6rem] lg:h-[10rem] 2xl:h-[12rem] drop-shadow-xl"
                                                        animate={{
                                                            y: [0, -8, 0],
                                                        }}
                                                        transition={{
